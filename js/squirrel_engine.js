...
// create, …) would collide with briar_engine.js's same-named helpers and throw
// "Identifier 'cur' has already been declared". The IIFE keeps them private;
// only window.SquirrelEngine escapes. The server copy needs no wrapper —
